...
from config import MIN_PIN_AREA, Region
...
def test_small_objects_filtered():
    """Test that objects below MIN_PIN_AREA are ignored."""
    frame = _make_frame()
    # Draw a tiny white dot (well below MIN_PIN_AREA)
